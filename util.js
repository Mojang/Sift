...
var util = module.exports = {
	...
	display: function (server, index) {
		console.log('(%s) %s - %s [%s] [%s] [%s]', (index), colors.green(server.account.name), colors.blue(server.account.type), colors.green(server.name), colors.yellow(server.hostname), colors.red(server.region))
	}
}